...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.ecoreannotations.StringAnnotationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringAnnotationTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public StringAnnotationTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((StringAnnotationType) object).getAnnotationType();
		return label == null || label.length() == 0 ? getString("_UI_StringAnnotationType_type")
				: getString("_UI_StringAnnotationType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringAnnotationType.class)) {
