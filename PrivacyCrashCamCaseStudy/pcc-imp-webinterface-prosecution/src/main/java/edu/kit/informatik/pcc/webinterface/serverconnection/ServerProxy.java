 ...
 */
public class ServerProxy implements JudgeAccessWeb, PersecutionInformationProvisionWeb, UserHandlingWeb{
    ...
    @Override
    public Response getConfidentialVideo(int videoId, int userId, String authenticationToken) {
    	Form f = new Form();
    	f.param("videoId", Integer.toString(videoId));
    ...
    public Response login(String email, String password) {
        ...
        return post(f, "account/login", null);
    }
...
//    	return authenticateUser(newAccount.getMail(), newAccount.getPassword());
//    }
