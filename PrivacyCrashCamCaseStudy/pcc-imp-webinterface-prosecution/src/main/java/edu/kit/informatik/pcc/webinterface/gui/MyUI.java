...
public class MyUI extends UI {
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        this.webinterface = new PersecutionWebinterface(new ServerCommunicator());
    }
    
    public PersecutionWebinterface getWebInterface() {
    ...
    public void login() {
        ...
        navigator.addView(VideoView.viewID, new VideoView(webinterface));
        navigator.addView(PrivacyView.viewID, new PrivacyView());
        navigator.addView(ImpressumView.viewID, new ImpressumView());
        navigator.setErrorView(new VideoView(webinterface));
